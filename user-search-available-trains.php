 ...
 <!-- end HEAD--> 
  <body>
    ...
    <!--navbar-->
      ...
      <div class="page-head">
          <h2 class="page-head-title">Search Train</h2>
                      ...
                      <td colspan="8">
                        <div class="container mx-0">
                          <div class="row">
                            ...
                            <div class="col-md-2 p-0 pr-2">
                              <div class="box border rounded <?php echo substr_count($row->status_3a,"WL") ? 'border-danger' : 'border-success'; ?>">
                                <div class="box-content px-4 py-2">
                                  <h4 class="class-type m-0 my-1 font-weight-bold">3A</h4>
                                  <div class="d-flex justify-content-between fs-3">
                                    <div class="font-weight-bold <?php echo substr_count($row->status_3a,"WL") ? 'text-danger' : 'text-success'; ?>"><?php echo $row->status_3a;?></div>
    ...
    <script src="assets/lib/bootstrap-datepicker/js/bootstrap-datepicker.min.js" type="text/javascript"></script>
